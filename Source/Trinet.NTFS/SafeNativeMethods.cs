...
using Trinet.NTFS.Properties;

namespace Trinet.NTFS
{
    ...
    internal static class SafeNativeMethods
    {
        ...
        #region Nested type: LargeInteger
        ...
        #region Nested type: Win32StreamId
        ...
        public static IList<Win32StreamInfo> ListStreams(string filePath)
        {
            ...
            using (
                SafeFileHandle hFile = SafeCreateFile(filePath, NativeFileAccess.GenericRead, FileShare.Read,
                                                      IntPtr.Zero, FileMode.Open, NativeFileFlags.BackupSemantics,
                                                      IntPtr.Zero))
                        ...
                        while (!finished)
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    if (
                                        !BackupRead(hFile, hName.MemoryBlock, streamId.StreamNameSize, out bytesRead,
                                    ...
                                    result.Add(new Win32StreamInfo
                                                   {
                                                       ...
                                                       StreamAttributes =
                                                           (FileStreamAttributes) streamId.StreamAttributes,
                                ...
                                if (!finished &&
                                    !BackupSeek(hFile, streamId.Size.Low, streamId.Size.High, out bytesSeekedLow,
