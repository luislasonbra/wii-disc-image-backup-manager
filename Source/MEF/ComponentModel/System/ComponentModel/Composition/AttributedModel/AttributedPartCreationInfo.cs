...
namespace System.ComponentModel.Composition.AttributedModel
{
    internal class AttributedPartCreationInfo : IReflectionPartCreationInfo
    {
        ...
        private static ConstructorInfo SelectPartConstructor(Type type)
        {
            ...
            // Should likely only happen for static or public abstract types
        ...
        private IEnumerable<MemberInfo> GetExportMembers(Type type)
        {
            ...
            // If the type is public abstract only find local static exports
            if (type.IsAbstract)
            {
        ...
        {
            // If the type is public abstract we aren't interested in type level exports
            if (type.IsAbstract)
            {
                yield break;
            }
