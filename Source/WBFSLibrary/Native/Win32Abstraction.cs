...
namespace WBFSLibrary
{
	...
	public static class WindowsAbstraction
	{
        ...
        {
            return (msg == WindowMessages.WM.DEVICECHANGE) && ((wParam == DBT.DEVICEARRIVAL) || (wParam == DBT.DEVICEREMOVECOMPLETE));
        }

        public static Boolean IsRemovingDevice(long wParam)
        {
            return wParam == DBT.DEVICEQUERYREMOVE;
        }

        public static Boolean HasRemovedDevice(long wParam)
        {
            return wParam == DBT.DEVICEREMOVECOMPLETE;
        }

        public static Boolean IsInsertingDevice(long wParam)
        {
            return wParam == DBT.DEVICEARRIVAL;
        }
