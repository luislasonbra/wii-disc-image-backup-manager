...
namespace WBFSLibrary
{
    ...
    public interface INamed
    {
		...
		#region Members
			...
			/* Determines whether the name of the current node is equal to the specified name, by respecting the specified comparison options. */
			Boolean AreNamesEqual(String Other_Name, CompareOptions Options);
