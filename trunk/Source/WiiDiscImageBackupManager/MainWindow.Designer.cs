namespace WBFSManager
{
    partial class MainWindow
    {
        ...
        private void InitializeComponent()
        {
			...
			this.radMenuItem_Tools = new Telerik.WinControls.UI.RadMenuItem();
			this.radMenuItem13 = new Telerik.WinControls.UI.RadMenuItem();
			this.radMenuItem14 = new Telerik.WinControls.UI.RadMenuItem();
			this.radMenuItem_Options = new Telerik.WinControls.UI.RadMenuItem();
			...
			this.radMenuItem_Web = new Telerik.WinControls.UI.RadMenuItem();
			...
			this.radMenuSeparatorItem_Help1 = new Telerik.WinControls.UI.RadMenuSeparatorItem();
			this.radMenuItem_CheckForUpdate = new Telerik.WinControls.UI.RadMenuItem();
			this.HelpMenu_ContactMenuItem = new Telerik.WinControls.UI.RadMenuItem();
			this.radMenuItem_BugReport = new Telerik.WinControls.UI.RadMenuItem();
			this.radMenuItem_FeatureRequest = new Telerik.WinControls.UI.RadMenuItem();
			this.radMenuItem_Feedback = new Telerik.WinControls.UI.RadMenuItem();
			this.radMenuItem_Statistics = new Telerik.WinControls.UI.RadMenuItem();
			this.radMenuSeparatorItem_Help2 = new Telerik.WinControls.UI.RadMenuSeparatorItem();
			this.HelpMenu_AboutMenuItem = new Telerik.WinControls.UI.RadMenuItem();
			...
			this.radMenuItem_Folders_Select_DiscNotInPartition = new Telerik.WinControls.UI.RadMenuItem();
			...
			this.radMenuItem_Folders_Select_DiscStorageFormat = new Telerik.WinControls.UI.RadMenuItem();
			...
			this.radMenuItem_Language = new Telerik.WinControls.UI.RadMenuItem();
			this.radMenuItem_NewLanguage = new Telerik.WinControls.UI.RadMenuItem();
			this.radMenuItem_EditLanguage = new Telerik.WinControls.UI.RadMenuItem();
			this.radMenuSeparatorItem_Language1 = new Telerik.WinControls.UI.RadMenuSeparatorItem();
			...
			this.SelectionDataColumn = new System.Data.DataColumn();
			...
			this.radMenuItem_View.Text = "View";
			// 
			// radMenuItem7
			// 
			...
			// radMenuItem_Tools
			// 
			this.radMenuItem_Tools.Items.AddRange(new Telerik.WinControls.RadItem[] {
            this.radMenuItem13,
            this.radMenuItem14});
			this.radMenuItem_Tools.Name = "radMenuItem_Tools";
			this.radMenuItem_Tools.Text = "Tools";
			// 
			// radMenuItem13
			// 
			...
			// radMenuItem_Options
			// 
			this.radMenuItem_Options.Items.AddRange(new Telerik.WinControls.RadItem[] {
            this.radMenuItem_Settings});
			this.radMenuItem_Options.Name = "radMenuItem_Options";
			this.radMenuItem_Options.Text = "Options";
			// 
            ...
            this.radMenuItem_Web,
            this.radMenuSeparatorItem_Help1,
            this.radMenuItem_CheckForUpdate,
            this.HelpMenu_ContactMenuItem,
            this.radMenuItem_Statistics,
            this.radMenuSeparatorItem_Help2,
            this.HelpMenu_AboutMenuItem});
			this.radMenuItem_Help.Name = "radMenuItem_Help";
			this.radMenuItem_Help.Text = "Help";
			// 
			// radMenuItem_Web
			// 
			this.radMenuItem_Web.Items.AddRange(new Telerik.WinControls.RadItem[] {
            this.radMenuItem10,
            this.radMenuItem11,
            this.radMenuItem12});
			this.radMenuItem_Web.Name = "radMenuItem_Web";
			this.radMenuItem_Web.Text = "Web";
			this.radMenuItem_Web.Click += new System.EventHandler(this.radMenuItem6_Click);
			// 
			// radMenuItem10
			// 
			...
			this.radMenuItem11.Text = "www.gbatemp.net";
			// 
			// radMenuItem12
			// 
			this.radMenuItem12.Name = "radMenuItem12";
			this.radMenuItem12.Text = "www.wiibrew.org";
			// 
			// radMenuSeparatorItem_Help1
			// 
			this.radMenuSeparatorItem_Help1.Name = "radMenuSeparatorItem_Help1";
			this.radMenuSeparatorItem_Help1.Text = "";
			// 
			// radMenuItem_CheckForUpdate
			// 
			this.radMenuItem_CheckForUpdate.Name = "radMenuItem_CheckForUpdate";
			this.radMenuItem_CheckForUpdate.Text = "Check for Update";
			this.radMenuItem_CheckForUpdate.Click += new System.EventHandler(this.radMenuItem8_Click);
			// 
			// HelpMenu_ContactMenuItem
			// 
			this.HelpMenu_ContactMenuItem.Items.AddRange(new Telerik.WinControls.RadItem[] {
            this.radMenuItem_BugReport,
            this.radMenuItem_FeatureRequest,
            this.radMenuItem_Feedback});
			this.HelpMenu_ContactMenuItem.Name = "HelpMenu_ContactMenuItem";
			this.HelpMenu_ContactMenuItem.Text = "Contact";
			// 
			// radMenuItem_BugReport
			// 
			this.radMenuItem_BugReport.Name = "radMenuItem_BugReport";
			this.radMenuItem_BugReport.Text = "Bug Report";
			this.radMenuItem_BugReport.Click += new System.EventHandler(this.radMenuItem18_Click);
			// 
			// radMenuItem_FeatureRequest
			// 
			this.radMenuItem_FeatureRequest.Name = "radMenuItem_FeatureRequest";
			this.radMenuItem_FeatureRequest.Text = "Feature Request";
			// 
			// radMenuItem_Feedback
			// 
			this.radMenuItem_Feedback.Name = "radMenuItem_Feedback";
			this.radMenuItem_Feedback.Text = "Feedback";
			// 
			// radMenuItem_Statistics
			// 
			this.radMenuItem_Statistics.Name = "radMenuItem_Statistics";
			this.radMenuItem_Statistics.Text = "Statistics";
			// 
			// radMenuSeparatorItem_Help2
			// 
			this.radMenuSeparatorItem_Help2.Name = "radMenuSeparatorItem_Help2";
			this.radMenuSeparatorItem_Help2.Text = "";
			// 
			// HelpMenu_AboutMenuItem
			// 
			this.HelpMenu_AboutMenuItem.Name = "HelpMenu_AboutMenuItem";
			this.HelpMenu_AboutMenuItem.Text = "About WBFS Mii";
			this.HelpMenu_AboutMenuItem.Click += new System.EventHandler(this.radMenuItem9_Click);
			// 
			// radSplitContainer1
			// 
			...
			this.radSplitContainer1.Location = new System.Drawing.Point(0, 22);
			this.radSplitContainer1.Name = "radSplitContainer1";
			// 
			// 
			// 
			this.radSplitContainer1.RootElement.MinSize = new System.Drawing.Size(25, 25);
			this.radSplitContainer1.Size = new System.Drawing.Size(1230, 531);
			...
			// splitPanel4
			// 
			this.splitPanel4.Controls.Add(this.ultraPictureBox3);
			...
			this.ultraPictureBox3.Dock = System.Windows.Forms.DockStyle.Fill;
			...
			// splitPanel5
			// 
			this.splitPanel5.Controls.Add(this.ultraPictureBox4);
			this.splitPanel5.Location = new System.Drawing.Point(0, 119);
			...
			this.ultraPictureBox4.Dock = System.Windows.Forms.DockStyle.Fill;
			...
			// splitPanel6
			// 
			this.splitPanel6.Controls.Add(this.ultraPictureBox1);
			this.splitPanel6.Location = new System.Drawing.Point(0, 238);
			...
			// splitPanel7
			// 
			this.splitPanel7.Controls.Add(this.ultraPictureBox2);
			this.splitPanel7.Location = new System.Drawing.Point(0, 358);
			...
			// splitPanel8
			// 
			this.splitPanel8.Controls.Add(this.ultraPictureBox5);
			this.splitPanel8.Location = new System.Drawing.Point(0, 478);
			...
			this.ultraPictureBox5.Dock = System.Windows.Forms.DockStyle.Fill;
			...
			// 
			this.radMenuItem_Folders_Add_Folders.Name = "radMenuItem_Folders_Add_Folders";
			...
			// 
			this.radMenuItem_Folders_Select_All.Name = "radMenuItem_Folders_Select_All";
			this.radMenuItem_Folders_Select_All.Text = "All";
			// 
			// radMenuItem_Folders_Select_None
			// 
			this.radMenuItem_Folders_Select_None.Name = "radMenuItem_Folders_Select_None";
			this.radMenuItem_Folders_Select_None.Text = "None";
			// 
			// radMenuSeparatorItem_Folders_Select_1
			// 
			this.radMenuSeparatorItem_Folders_Select_1.Name = "radMenuSeparatorItem_Folders_Select_1";
			this.radMenuSeparatorItem_Folders_Select_1.Text = "1";
			// 
			// radMenuItem_Folders_Select_DiscNotInPartition
			// 
			this.radMenuItem_Folders_Select_DiscNotInPartition.Items.AddRange(new Telerik.WinControls.RadItem[] {
            this.radMenuItem24,
            this.radMenuSeparatorItem3});
			this.radMenuItem_Folders_Select_DiscNotInPartition.Name = "radMenuItem_Folders_Select_DiscNotInPartition";
			this.radMenuItem_Folders_Select_DiscNotInPartition.Text = "Discs that don\'t exist in partition... ";
			this.radMenuItem_Folders_Select_DiscNotInPartition.Click += new System.EventHandler(this.radMenuItem17_Click);
			// 
			// radMenuItem24
			// 
			this.radMenuItem24.Name = "radMenuItem24";
			this.radMenuItem24.Text = "All";
			// 
			...
			// 
			// radMenuItem_Folders_Select_DiscStorageFormat
			// 
			this.radMenuItem_Folders_Select_DiscStorageFormat.Items.AddRange(new Telerik.WinControls.RadItem[] {
            this.radMenuItem28,
            this.radMenuItem29,
            this.radMenuItem30,
            this.radMenuItem31,
            this.radMenuItem32});
			this.radMenuItem_Folders_Select_DiscStorageFormat.Name = "radMenuItem_Folders_Select_DiscStorageFormat";
			this.radMenuItem_Folders_Select_DiscStorageFormat.Text = "Discs that are stored as...";
			this.radMenuItem_Folders_Select_DiscStorageFormat.Click += new System.EventHandler(this.radMenuItem24_Click);
			// 
			// radMenuItem28
			// 
			this.radMenuItem28.Name = "radMenuItem28";
			this.radMenuItem28.Text = "WBFS";
			// 
			// radMenuItem29
			// 
			this.radMenuItem29.Name = "radMenuItem29";
			this.radMenuItem29.Text = "ISO";
			// 
			// radMenuItem30
			// 
			this.radMenuItem30.Name = "radMenuItem30";
			this.radMenuItem30.Text = "CISO";
			// 
			// radMenuItem31
			// 
			this.radMenuItem31.Name = "radMenuItem31";
			this.radMenuItem31.Text = "Archive";
			// 
			// radMenuItem32
			// 
			this.radMenuItem32.Name = "radMenuItem32";
			this.radMenuItem32.Text = "radMenuItem32";
			// 
			// radMenuSeparatorItem_Folders_Select_2
			// 
			this.radMenuSeparatorItem_Folders_Select_2.Name = "radMenuSeparatorItem_Folders_Select_2";
			this.radMenuSeparatorItem_Folders_Select_2.Text = "2";
			// 
			// radMenuItem_Folders_Select_Invert
			// 
			...
			this.radMenuItem15.Text = "radMenuItem15";
			// 
			// radMenuItem16
			// 
			...
			// radProgressBar1
			// 
			this.radProgressBar1.AutoSize = true;
			...
			this.radProgressBar1.Text = "${DEVICE_NAME)}(${FILESYSTEM}) is ${STATE} - Used ${USED_SPACE} of ${TOTAL_SPACE}" +
    " - ${FREE_SPACE} remaining - ${P_USED_SPACE}% used, ${P_FREE_SPACE}% available.";
			this.radProgressBar1.TextAlignment = System.Drawing.ContentAlignment.MiddleCenter;
			this.radProgressBar1.ThemeName = "Windows7";
			this.radProgressBar1.Value1 = 33;
			this.radProgressBar1.Value2 = 66;
			// 
			// radStatusStrip1
			// 
			...
			this.radStatusStrip1.ThemeName = "Windows7";
			// 
			// radLabelElement1
			// 
			...
			this.radLabelElement1.Text = "${SELECTION_COUNT} selected (${SELECTION_ADDITIVE_SIZE})";
			...
			this.radStatusStrip1.SetSpring(this.radToolStripSeparatorItem1, false);
			...
			this.radLabelElement2.Text = "${OBJECT_COUNT} selected (${OBJECT_ADDITIVE_SIZE})";
			...
			// 
			this.radMenuItem_AddFiles.Name = "radMenuItem_AddFiles";
			this.radMenuItem_AddFiles.Text = "Add Files";
			// 
			// radMenuItem2
			// 
			...
			// 
			// radMenuItem_Language
			// 
			this.radMenuItem_Language.Items.AddRange(new Telerik.WinControls.RadItem[] {
            this.radMenuItem_NewLanguage,
            this.radMenuItem_EditLanguage,
            this.radMenuSeparatorItem_Language1,
            this.radMenuItem_DefaultLanguage});
			this.radMenuItem_Language.Name = "radMenuItem_Language";
			this.radMenuItem_Language.Text = "Language";
			// 
			// radMenuItem_NewLanguage
			// 
			this.radMenuItem_NewLanguage.Name = "radMenuItem_NewLanguage";
			this.radMenuItem_NewLanguage.Text = "New Language";
			// 
			// radMenuItem_EditLanguage
			// 
			this.radMenuItem_EditLanguage.Name = "radMenuItem_EditLanguage";
			this.radMenuItem_EditLanguage.Text = "Edit Language";
			// 
			// radMenuSeparatorItem_Language1
			// 
			this.radMenuSeparatorItem_Language1.Name = "radMenuSeparatorItem_Language1";
			this.radMenuSeparatorItem_Language1.Text = "";
			// 
			// radMenuItem_DefaultLanguage
			// 
			this.radMenuItem_DefaultLanguage.Name = "radMenuItem_DefaultLanguage";
			this.radMenuItem_DefaultLanguage.Text = "Default Language";
			// 
            ...
            this.radMenuItem_Tools,
            this.radMenuItem_Options,
            this.radMenuItem_Language,
		...
		private Telerik.WinControls.UI.RadMenuItem radMenuItem_Options;
		private Telerik.WinControls.UI.RadMenuItem radMenuItem_Help;
		private Telerik.WinControls.UI.RadMenuItem radMenuItem_Web;
		private Telerik.WinControls.UI.RadMenuSeparatorItem radMenuSeparatorItem_Help1;
		private Telerik.WinControls.UI.RadMenuItem HelpMenu_ContactMenuItem;
		private Telerik.WinControls.UI.RadMenuItem radMenuItem_CheckForUpdate;
		private Telerik.WinControls.UI.RadMenuSeparatorItem radMenuSeparatorItem_Help2;
		private Telerik.WinControls.UI.RadMenuItem HelpMenu_AboutMenuItem;
		...
		private Telerik.WinControls.UI.RadMenuItem radMenuItem_Language;
		private Telerik.WinControls.UI.RadMenuItem radMenuItem_NewLanguage;
		...
		private Telerik.WinControls.UI.RadMenuSeparatorItem radMenuSeparatorItem_Folders_Select_2;
		...
		private Telerik.WinControls.UI.RadMenuItem radMenuItem_Folders_Select_Invert;
