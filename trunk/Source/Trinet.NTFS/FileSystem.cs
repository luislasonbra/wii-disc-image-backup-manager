...
namespace Trinet.NTFS
{
    ...
    public static class FileSystem
    {
        ...
        public static IList<AlternateDataStreamInfo> ListAlternateDataStreams(string filePath)
        {
            ...
            return ListAlternateDataStreams(CreateInfo(filePath));
        }
        ...
        {
            if (string.IsNullOrEmpty(filePath)) throw new ArgumentNullException("filePath");
            return AlternateDataStreamExists(CreateInfo(filePath), streamName);
        }
        ...
        public static AlternateDataStreamInfo GetAlternateDataStream(this FileSystemInfo file, string streamName)
        {
            return GetAlternateDataStream(file, streamName, FileMode.OpenOrCreate);
        }
        ...
        {
            if (string.IsNullOrEmpty(filePath)) throw new ArgumentNullException("filePath");
            return GetAlternateDataStream(CreateInfo(filePath), streamName, mode);
        }
        ...
        {
            if (string.IsNullOrEmpty(filePath)) throw new ArgumentNullException("filePath");
            return DeleteAlternateDataStream(CreateInfo(filePath), streamName);
        }
